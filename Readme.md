...
5. Build the code:
    1. `cd .\BensEngineerningMetrics`
    2. `dotnet build`

6. Run the code:
   `dotnet run`

Note: for subsequent runs, you can simply run the .\BensEngineerningMetrics\bin\Debug\net9.0\BensEngineerningMetrics.exe directly, or use the `dotnet run` command again.
...
``.\BensEngineerningMetrics\bin\Debug\net9.0\BensEngineerningMetrics.exe PMPLAN_RBURNUP``
